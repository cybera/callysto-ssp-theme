<?php
$this->data['header'] = $this->t('{callysto:callysto:selectidp_title}');
...
?>
    <h2><?php echo $this->t('{callysto:callysto:selectidp_text}'); ?></h2>
    <?php $img_url = SimpleSAML\Module::getModuleURL("callysto/default-sp.png"); ?>
    <p><img class="idpselect_img" src="<?php echo $img_url; ?>"/></p>
    <form class="idpselect_form clearfix" method="get" action="<?php echo $this->data['urlpattern']; ?>">
        ...
        if ($this->data['rememberenabled']) {
            echo('<br/><br/><p class="remember"><input type="checkbox" name="remember" value="1" />'.$this->t('remember')) . '</p>';
        }
        ?>
    </form>
